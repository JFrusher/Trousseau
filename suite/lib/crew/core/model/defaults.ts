...
export function sampleDoc(): BrigadeDoc {
  ...
  const people = [
    { id: "per-ana", name: "Ana Willis", teamId: teamId("caterer"), phone: "07700 900701", notes: "" },
    { id: "per-sam", name: "Sam Okafor", teamId: teamId("caterer"), phone: "07700 900702", notes: "" },
    { id: "per-joe", name: "Joe Marsh", teamId: null, phone: "07700 900703", notes: "Venue duty manager." },
    { id: "per-nell", name: "Nell Hart", teamId: teamId("florist"), phone: "07700 900704", notes: "" },
  ];
