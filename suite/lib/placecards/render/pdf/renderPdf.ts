...
import { HAIRLINE_PT } from "../../geometry/cropMarks";
import { effectiveScale } from "../../print/printerProfile";
import { scaleSheetContent } from "../../print/scaleSheet";
import { centreOf, rotatePoint } from "../../geometry/transform";
import { fitImage } from "../../template/imageFit";
import { layoutLines } from "../../text/layout";
import type { LoadedFont } from "../../text/measure";
import type { Hex, Mm, Point, Rect, ResolvedElement, Segment, Sheet } from "../../types";
